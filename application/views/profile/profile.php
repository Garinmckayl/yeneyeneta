...
<section class="p-3  d-flex d-column col-md-9 ml-auto" id="about">
    <div class="my-auto frontprofile">
       ...
       <?php if($user['firstname']): ?> <h3 class="">First Name: <b class="ml-3"><?php echo $user['firstname']; ?></b></h3> <?php endif; ?>
       <?php if($user['lastname']): ?> <h3 class="">Last Name: <b class="ml-3"><?php echo $user['lastname']; ?></b></h3> <?php endif; ?>
