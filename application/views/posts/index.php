<div class="container">
    ...
    <?php
    echo '<p class="alert alert-success alert-dismissible"><i class="fa fa-check-circle"></i> Success: '.$this->session->flashdata('post_created'). '<button type="button" class="close" data-dismiss="alert">�</button></P>' ; ?>
    <?php
    endif; ?>
    <div class="jumbotron p-3 p-md-5 text-white rounded bg-dark front">
        <div class="col-md-6 px-0">
            <h1 class="display-4 font-italic">A blog for teachers and students and for anybody who loves wisdom. </h1>
            <p class="lead my-3 text-white">
                To get started you don't need an account but to be more interactive you can create an account and login! enjoy being yeneta and learning from yeneta:)  <img class="footerimg" src="<?php echo site_url();?>assets/img/24.png">&trade;
            </p>
        </div>
    </div>
    <div class="row mb-2">
            ...
            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                <div class="card-body d-flex flex-column align-items-start">
                    ...
                    <h3 class="mb-0">
                        ...
                        <?php
                        echo word_limiter($post['title'], 4); ?>
                        </a>
                    </h3>
                    <div class="mb-1 text-muted">
                        ...
                        echo $post['usertitle'] ?>
                        <?php
                        echo word_limiter($post['username'], 3); ?>
                        </span>
                    </div>
